...
<head>
  ...
  <title>Retrohub &mdash; Registration Member</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
            <div class="login-brand">
              <img src="<?php echo base_url('assets/'); ?>img/logo/logo.png" alt="logo" width="150">
            </div>

            <div class="card card-primary">
              <div class="card-header"><h4>Register Now</h4></div>

              <div class="card-body">
                <form method="POST" enctype="multipart/form-data" action="<?php echo site_url('registration'); ?>" >
                  <div class="row">
                    <div class="form-group col-6">
                      <label for="full_name">Full Name</label>
                      <input id="full_name" type="text" class="form-control" name="nama" autofocus>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-6">
                      ...
                      <?php echo form_error('password_confirm','<div class="text-danger small ml-2 mt-2">','!</div>'); ?>
                    </div>
                  </div>
                ...
                <div class="text-center">
                    <a href="<?php echo site_url('auth/login'); ?>" class="">Already have an account? Login!</a>
                </div>
              </div>
            </div>
